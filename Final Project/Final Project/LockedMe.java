...
public class LockedMe 
{
    ...
    private static final String WELCOME_PROMPT =
            "\n*#*#*#*#*#*#*#*  LockedMe.com *#*#*#*#*#*#*#*#* "+
              ...
              "\n  *LockedMe is the Application From Company Lockers Pvt. Ltd.*"+
                               
                    "\n********************WELCOME from Abhishek**************\n";
    ...
    void showSecondaryMenu() 
    {
        ...
        try{
            ...
            switch (option)
            {
                ...
                case 'b' : {
                    System.out.print("from Deleting a file...Please Enter a File Name : ");
                    String filename = scanner.next().trim();
                    deleteFile(filename);
                    break;
                }
                case 'c' : {
                    System.out.print("name Searching a file...Please Enter a File Name : ");
                    String filename = scanner.next().trim();
                    searchFile(filename);
                    break;
                }
